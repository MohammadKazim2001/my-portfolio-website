...
const socialLinks = [
  ...
  {
    href: "https://www.linkedin.com/in/mohammad-kazim-amiri-111210323",
    icon: (
      <svg
        width="24"
        height="24"
      ...
      <div className="container lg:grid lg:grid-cols-2">
        ...
        >
          ...
          <input
            type="hidden"
            name="access_key"
            value="3d60772d-6c56-4c28-8cc8-bf3fd5e569aa"
          />

          {/* Email subject line (required for deliverability) */}
          <input
            type="hidden"
            name="subject"
